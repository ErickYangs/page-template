  ...
  <CommonStep :hash="hash" :step="step">
    <div>
      ...
      <div class="form">
        ...
        <div class="form-info">
          <div class="nft-title">{{ nftInfo.name }}</div>
          <div class="form-cell info-list">
            ...
            />
            <InfoLabel :label="t('my_last_bid')" :balance="nftInfo.last_bid" />
          ...
          <div class="form-cell">
            <CommonButton
              :label="placeBidDisableLabel || t('update_bid')"
              type="submit"
              @click="emitUpdatePlaceBid"
...
import { FormStep, DEBT_PERCENT } from "@/utils/enum";
